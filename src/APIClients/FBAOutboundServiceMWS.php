...
class FBAOutboundServiceMWS_Client implements FBAOutboundServiceMWS_Interface
{
    ...
    public function cancelFulfillmentOrder($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_CancelFulfillmentOrderRequest)) {
            require_once __DIR__ . '/Model/CancelFulfillmentOrderRequest.php';
        ...
        require_once __DIR__ . '/Model/CancelFulfillmentOrderResponse.php';
    ...
    public function createFulfillmentOrder($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_CreateFulfillmentOrderRequest)) {
            require_once __DIR__ . '/Model/CreateFulfillmentOrderRequest.php';
        ...
        require_once __DIR__ . '/Model/CreateFulfillmentOrderResponse.php';
    ...
    public function createFulfillmentReturn($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_CreateFulfillmentReturnRequest)) {
            require_once __DIR__ . '/Model/CreateFulfillmentReturnRequest.php';
        ...
        require_once __DIR__ . '/Model/CreateFulfillmentReturnResponse.php';
    ...
    public function getFulfillmentOrder($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_GetFulfillmentOrderRequest)) {
            require_once __DIR__ . '/Model/GetFulfillmentOrderRequest.php';
        ...
        require_once __DIR__ . '/Model/GetFulfillmentOrderResponse.php';
    ...
    public function getFulfillmentPreview($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_GetFulfillmentPreviewRequest)) {
            require_once __DIR__ . '/Model/GetFulfillmentPreviewRequest.php';
        ...
        require_once __DIR__ . '/Model/GetFulfillmentPreviewResponse.php';
    ...
    public function getPackageTrackingDetails($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_GetPackageTrackingDetailsRequest)) {
            require_once __DIR__ . '/Model/GetPackageTrackingDetailsRequest.php';
        ...
        require_once __DIR__ . '/Model/GetPackageTrackingDetailsResponse.php';
    ...
    public function listAllFulfillmentOrders($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersRequest)) {
            require_once __DIR__ . '/Model/ListAllFulfillmentOrdersRequest.php';
        ...
        require_once __DIR__ . '/Model/ListAllFulfillmentOrdersResponse.php';
    ...
    public function listAllFulfillmentOrdersByNextToken($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersByNextTokenRequest)) {
            require_once __DIR__ . '/Model/ListAllFulfillmentOrdersByNextTokenRequest.php';
        ...
        require_once __DIR__ . '/Model/ListAllFulfillmentOrdersByNextTokenResponse.php';
    ...
    public function listReturnReasonCodes($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_ListReturnReasonCodesRequest)) {
            require_once __DIR__ . '/Model/ListReturnReasonCodesRequest.php';
        ...
        require_once __DIR__ . '/Model/ListReturnReasonCodesResponse.php';
    ...
    public function updateFulfillmentOrder($request)
    {
        if (!($request instanceof FBAOutboundServiceMWS_Model_UpdateFulfillmentOrderRequest)) {
            require_once __DIR__ . '/Model/UpdateFulfillmentOrderRequest.php';
        ...
        require_once __DIR__ . '/Model/UpdateFulfillmentOrderResponse.php';
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new FBAOutboundServiceMWS_Exception(['ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."]);
            }
            ...
            throw new FBAOutboundServiceMWS_Exception(['Exception' => $t, 'Message' => $t->getMessage()]);
        }
    }
