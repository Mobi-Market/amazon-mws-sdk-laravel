...
class MWSRecommendationsSectionService_Client implements MWSRecommendationsSectionService_Interface
{
    ...
    public function getLastUpdatedTimeForRecommendations($request)
    {
        if (!($request instanceof MWSRecommendationsSectionService_Model_GetLastUpdatedTimeForRecommendationsRequest)) {
            require_once __DIR__ . '/Model/GetLastUpdatedTimeForRecommendationsRequest.php';
        ...
        require_once __DIR__ . '/Model/GetLastUpdatedTimeForRecommendationsResponse.php';
    ...
    public function listRecommendations($request)
    {
        if (!($request instanceof MWSRecommendationsSectionService_Model_ListRecommendationsRequest)) {
            require_once __DIR__ . '/Model/ListRecommendationsRequest.php';
        ...
        require_once __DIR__ . '/Model/ListRecommendationsResponse.php';
    ...
    public function listRecommendationsByNextToken($request)
    {
        if (!($request instanceof MWSRecommendationsSectionService_Model_ListRecommendationsByNextTokenRequest)) {
            require_once __DIR__ . '/Model/ListRecommendationsByNextTokenRequest.php';
        ...
        require_once __DIR__ . '/Model/ListRecommendationsByNextTokenResponse.php';
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new MWSRecommendationsSectionService_Exception(['ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."]);
            }
            ...
            throw new MWSRecommendationsSectionService_Exception(['Exception' => $t, 'Message' => $t->getMessage()]);
        }
    }
