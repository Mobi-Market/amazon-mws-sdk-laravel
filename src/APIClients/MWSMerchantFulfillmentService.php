...
class MWSMerchantFulfillmentService_Client implements MWSMerchantFulfillmentService_Interface
{
    ...
    public function cancelShipment($request)
    {
        if (!($request instanceof MWSMerchantFulfillmentService_Model_CancelShipmentRequest)) {
            require_once __DIR__ . '/Model/CancelShipmentRequest.php';
        ...
        require_once __DIR__ . '/Model/CancelShipmentResponse.php';
    ...
    public function createShipment($request)
    {
        if (!($request instanceof MWSMerchantFulfillmentService_Model_CreateShipmentRequest)) {
            require_once __DIR__ . '/Model/CreateShipmentRequest.php';
        ...
        require_once __DIR__ . '/Model/CreateShipmentResponse.php';
    ...
    public function getAdditionalSellerInputs($request)
    {
        if (!($request instanceof MWSMerchantFulfillmentService_Model_GetAdditionalSellerInputsRequest)) {
            require_once __DIR__ . '/Model/GetAdditionalSellerInputsRequest.php';
        ...
        require_once __DIR__ . '/Model/GetAdditionalSellerInputsResponse.php';
    ...
    public function getEligibleShippingServices($request)
    {
        if (!($request instanceof MWSMerchantFulfillmentService_Model_GetEligibleShippingServicesRequest)) {
            require_once __DIR__ . '/Model/GetEligibleShippingServicesRequest.php';
        ...
        require_once __DIR__ . '/Model/GetEligibleShippingServicesResponse.php';
    ...
    public function getShipment($request)
    {
        if (!($request instanceof MWSMerchantFulfillmentService_Model_GetShipmentRequest)) {
            require_once __DIR__ . '/Model/GetShipmentRequest.php';
        ...
        require_once __DIR__ . '/Model/GetShipmentResponse.php';
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new MWSMerchantFulfillmentService_Exception(['ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."]);
            }
            ...
            throw new MWSMerchantFulfillmentService_Exception(['Exception' => $t, 'Message' => $t->getMessage()]);
        }
    }
