...
class MarketplaceWebServiceSellers_Client implements MarketplaceWebServiceSellers_Interface
{
    ...
    public function listMarketplaceParticipations($request)
    {
        if (!($request instanceof MarketplaceWebServiceSellers_Model_ListMarketplaceParticipationsRequest)) {
            require_once __DIR__ . '/Model/ListMarketplaceParticipationsRequest.php';
        ...
        require_once __DIR__ . '/Model/ListMarketplaceParticipationsResponse.php';
    ...
    public function listMarketplaceParticipationsByNextToken($request)
    {
        if (!($request instanceof MarketplaceWebServiceSellers_Model_ListMarketplaceParticipationsByNextTokenRequest)) {
            require_once __DIR__ . '/Model/ListMarketplaceParticipationsByNextTokenRequest.php';
        ...
        require_once __DIR__ . '/Model/ListMarketplaceParticipationsByNextTokenResponse.php';
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new MarketplaceWebServiceSellers_Exception(['ErrorCode' => 'InvalidServiceURL', 'Message' => "Missing serviceUrl configuration value. You may obtain a list of valid MWS URLs by consulting the MWS Developer's Guide, or reviewing the sample code published along side this library."]);
            }
            ...
            throw new MarketplaceWebServiceSellers_Exception(['Exception' => $t, 'Message' => $t->getMessage()]);
        }
    }
