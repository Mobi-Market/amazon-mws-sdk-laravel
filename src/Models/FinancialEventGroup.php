...
class FinancialEventGroup extends Model
{
    ...
    {
        $this->_fields = [
            'FinancialEventGroupId'    => ['FieldValue' => null, 'FieldType' => 'string'],
            'ProcessingStatus'         => ['FieldValue' => null, 'FieldType' => 'string'],
            'FundTransferStatus'       => ['FieldValue' => null, 'FieldType' => 'string'],
            'OriginalTotal'            => ['FieldValue' => null, 'FieldType' => 'Currency'],
            'ConvertedTotal'           => ['FieldValue' => null, 'FieldType' => 'Currency'],
            'FundTransferDate'         => ['FieldValue' => null, 'FieldType' => 'string'],
            'TraceId'                  => ['FieldValue' => null, 'FieldType' => 'string'],
            'AccountTail'              => ['FieldValue' => null, 'FieldType' => 'string'],
            'BeginningBalance'         => ['FieldValue' => null, 'FieldType' => 'Currency'],
            'FinancialEventGroupStart' => ['FieldValue' => null, 'FieldType' => 'string'],
            'FinancialEventGroupEnd'   => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['FinancialEventGroupId']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['ProcessingStatus']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['FundTransferStatus']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['OriginalTotal']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['ConvertedTotal']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['FundTransferDate']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['TraceId']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['AccountTail']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['BeginningBalance']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['FinancialEventGroupStart']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['FinancialEventGroupEnd']['FieldValue'];
    }
