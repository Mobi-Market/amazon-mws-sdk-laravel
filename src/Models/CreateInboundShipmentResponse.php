 ...
 * </ul>
 */
class CreateInboundShipmentResponse extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            'CreateInboundShipmentResult' => ['FieldValue' => null, 'FieldType' => 'CreateInboundShipmentResult'],
    ...
    {
        return null !== $this->_fields['CreateInboundShipmentResult']['FieldValue'];
    }
