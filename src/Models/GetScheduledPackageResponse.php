 ...
 * <ul>
 *
 * <li>GetScheduledPackageResult: GetScheduledPackageResult</li>
 * <li>ResponseMetadata: ResponseMetadata</li>
 * <li>ResponseHeaderMetadata: ResponseHeaderMetadata</li>
 *
 * </ul>
 */
class GetScheduledPackageResponse extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            'GetScheduledPackageResult' => ['FieldValue' => null, 'FieldType' => 'GetScheduledPackageResult'],
     ...
     *
     * @param GetScheduledPackageResult getScheduledPackageResult
     * @param mixed $value
     *
    ...
    {
        return null !== $this->_fields['GetScheduledPackageResult']['FieldValue'];
    }
    ...
    /**
     * Construct GetScheduledPackageResponse from XML string.
     *
     * @param $xml
     *        XML string to construct from
     *
     * @return GetScheduledPackageResponse
     */
    public static function fromXML($xml)
    {
        ...
        throw new \Exception('Unable to construct GetScheduledPackageResponse from provided XML. 
