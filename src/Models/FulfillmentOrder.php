...
class FulfillmentOrder extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'ReceivedDateTime'         => ['FieldValue' => null, 'FieldType' => 'string'],
            'FulfillmentOrderStatus'   => ['FieldValue' => null, 'FieldType' => 'string'],
            'StatusUpdatedDateTime'    => ['FieldValue' => null, 'FieldType' => 'string'],
    ...
    {
        return null !== $this->_fields['ReceivedDateTime']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['FulfillmentOrderStatus']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['StatusUpdatedDateTime']['FieldValue'];
    }
