 ...
 * <li>AmazonPrepFeesDetailsList: AmazonPrepFeesDetailsList</li>
 *
 * </ul>
 */
class SKUPrepInstructions extends Model
{
    ...
    {
        return null !== $this->_fields['AmazonPrepFeesDetailsList']['FieldValue'];
    }
