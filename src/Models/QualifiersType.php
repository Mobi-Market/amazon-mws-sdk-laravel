...
class QualifiersType extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'ShipsDomestically'            => ['FieldValue' => null, 'FieldType' => 'string'],
            'ShippingTime'                 => ['FieldValue' => null, 'FieldType' => 'ShippingTimeType'],
            'SellerPositiveFeedbackRating' => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['ShipsDomestically']['FieldValue'];
    }
