...
class ListFinancialEventsRequest extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'PostedAfter'           => ['FieldValue' => null, 'FieldType' => 'string'],
            'PostedBefore'          => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['PostedAfter']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['PostedBefore']['FieldValue'];
    }
