...
class GetProductCategoriesForSKUResponse extends Model
{
    ...
    {
        $this->_fields = [
            'GetProductCategoriesForSKUResult' => ['FieldValue' => null, 'FieldType' => 'GetProductCategoriesForSKUResult'],
    ...
    {
        return null !== $this->_fields['GetProductCategoriesForSKUResult']['FieldValue'];
    }
