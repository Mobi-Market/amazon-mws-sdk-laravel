 ...
 * </ul>
 */
class PutTransportContentResponse extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            'PutTransportContentResult' => ['FieldValue' => null, 'FieldType' => 'PutTransportContentResult'],
    ...
    {
        return null !== $this->_fields['PutTransportContentResult']['FieldValue'];
    }
