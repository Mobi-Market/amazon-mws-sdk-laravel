...
class ListMatchingProductsRequest extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'Query'          => ['FieldValue' => null, 'FieldType' => 'string'],
            'QueryContextId' => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['Query']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['QueryContextId']['FieldValue'];
    }
