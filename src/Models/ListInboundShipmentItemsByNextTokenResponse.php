...
class ListInboundShipmentItemsByNextTokenResponse extends Model
{
    ...
    {
        $this->_fields = [
            'ListInboundShipmentItemsByNextTokenResult' => ['FieldValue' => null, 'FieldType' => 'ListInboundShipmentItemsByNextTokenResult'],
    ...
    {
        return null !== $this->_fields['ListInboundShipmentItemsByNextTokenResult']['FieldValue'];
    }
