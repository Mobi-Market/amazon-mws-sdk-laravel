 ...
 * </ul>
 */
class ListInboundShipmentsResponse extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            'ListInboundShipmentsResult' => ['FieldValue' => null, 'FieldType' => 'ListInboundShipmentsResult'],
    ...
    {
        return null !== $this->_fields['ListInboundShipmentsResult']['FieldValue'];
    }
