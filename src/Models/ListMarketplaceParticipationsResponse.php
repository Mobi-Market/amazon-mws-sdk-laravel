...
class ListMarketplaceParticipationsResponse extends Model
{
    ...
    {
        $this->_fields = [
            'ListMarketplaceParticipationsResult' => ['FieldValue' => null, 'FieldType' => 'ListMarketplaceParticipationsResult'],
    ...
    {
        return null !== $this->_fields['ListMarketplaceParticipationsResult']['FieldValue'];
    }
