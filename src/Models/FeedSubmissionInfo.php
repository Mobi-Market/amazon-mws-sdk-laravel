...
class FeedSubmissionInfo extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->fields = [
            ...
            'FeedProcessingStatus'    => ['FieldValue' => null, 'FieldType' => 'string'],
            'StartedProcessingDate'   => ['FieldValue' => null, 'FieldType' => 'DateTime'],
            'CompletedProcessingDate' => ['FieldValue' => null, 'FieldType' => 'DateTime'],
        ];
    ...
    {
        return null !== $this->fields['FeedProcessingStatus']['FieldValue'];
    }
    ...
    {
        return null !== $this->fields['CompletedProcessingDate']['FieldValue'];
    }
}
