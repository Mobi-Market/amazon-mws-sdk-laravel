...
class ListRegisteredDestinationsResponse extends Model
{
    ...
    {
        $this->_fields = [
            'ListRegisteredDestinationsResult' => ['FieldValue' => null, 'FieldType' => 'ListRegisteredDestinationsResult'],
    ...
    {
        return null !== $this->_fields['ListRegisteredDestinationsResult']['FieldValue'];
    }
