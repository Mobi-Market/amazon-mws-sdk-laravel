 ...
 * <li>LiquidationProceedsAmount: Currency</li>
 * <li>LiquidationFeeAmount: Currency</li>
 *
 * </ul>
 */
class FBALiquidationEvent extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'OriginalRemovalOrderId'    => ['FieldValue' => null, 'FieldType' => 'string'],
            'LiquidationProceedsAmount' => ['FieldValue' => null, 'FieldType' => 'Currency'],
            'LiquidationFeeAmount'      => ['FieldValue' => null, 'FieldType' => 'Currency'],
        ];
    ...
    {
        return null !== $this->_fields['OriginalRemovalOrderId']['FieldValue'];
    }
     ...
     *
     * @param Currency liquidationProceedsAmount
     * @param mixed $value
     *
     * @return $this instance
     */
    ...
    {
        return null !== $this->_fields['LiquidationProceedsAmount']['FieldValue'];
    }
     ...
     *
     * @param Currency liquidationFeeAmount
     * @param mixed $value
     *
     * @return $this instance
     */
    ...
    {
        return null !== $this->_fields['LiquidationFeeAmount']['FieldValue'];
    }
