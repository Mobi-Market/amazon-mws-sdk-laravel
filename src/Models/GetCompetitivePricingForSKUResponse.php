...
class GetCompetitivePricingForSKUResponse extends Model
{
    ...
    {
        $this->_fields = [
            'GetCompetitivePricingForSKUResult' => ['FieldValue' => [], 'FieldType' => ['GetCompetitivePricingForSKUResult']],
    ...
    {
        if (null == $this->_fields['GetCompetitivePricingForSKUResult']['FieldValue']) {
            $this->_fields['GetCompetitivePricingForSKUResult']['FieldValue'] = [];
        }
     ...
     */
    public function unsetGetCompetitivePricingForSKUResult(): void
    {
        $this->_fields['GetCompetitivePricingForSKUResult']['FieldValue'] = [];
    }
