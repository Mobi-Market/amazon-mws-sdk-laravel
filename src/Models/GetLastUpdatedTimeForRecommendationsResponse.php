 ...
 * </ul>
 */
class GetLastUpdatedTimeForRecommendationsResponse extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            'GetLastUpdatedTimeForRecommendationsResult' => ['FieldValue' => null, 'FieldType' => 'GetLastUpdatedTimeForRecommendationsResult'],
    ...
    {
        return null !== $this->_fields['GetLastUpdatedTimeForRecommendationsResult']['FieldValue'];
    }
