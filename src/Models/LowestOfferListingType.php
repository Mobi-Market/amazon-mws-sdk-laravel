...
class LowestOfferListingType extends Model
{
    ...
    {
        $this->_fields = [
            'Qualifiers'                      => ['FieldValue' => null, 'FieldType' => 'QualifiersType'],
            'NumberOfOfferListingsConsidered' => ['FieldValue' => null, 'FieldType' => 'int'],
            'SellerFeedbackCount'             => ['FieldValue' => null, 'FieldType' => 'int'],
            'Price'                           => ['FieldValue' => null, 'FieldType' => 'PriceType'],
            'MultipleOffersAtLowestPrice'     => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['Qualifiers']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['NumberOfOfferListingsConsidered']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['SellerFeedbackCount']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['MultipleOffersAtLowestPrice']['FieldValue'];
    }
