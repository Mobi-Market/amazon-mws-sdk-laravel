...
class ListInventorySupplyRequest extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = [
            ...
            'SellerSkus'         => ['FieldValue' => null, 'FieldType' => 'SellerSkuList'],
            'QueryStartDateTime' => ['FieldValue' => null, 'FieldType' => 'string'],
            'ResponseGroup'      => ['FieldValue' => null, 'FieldType' => 'string'],
        ];
    ...
    {
        return null !== $this->_fields['SellerSkus']['FieldValue'];
    }
    ...
    {
        return null !== $this->_fields['ResponseGroup']['FieldValue'];
    }
